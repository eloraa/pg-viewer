...
function FormItem({ className, ...props }: React.ComponentProps<'div'>) {
  ...
  return (
    <FormItemContext.Provider value={{ id }}>
      <div data-slot="form-item" className={cn('flex flex-col space-y-2', className)} {...props} />
...
function FormLabel({ className, ...props }: React.ComponentProps<typeof LabelPrimitive.Root>) {
  ...
  return <Label data-slot="form-label" data-error={!!error} className={cn('data-[error=true]:text-destructive-primary text-sm font-medium', className)} htmlFor={formItemId} {...props} />;
}
...
function FormMessage({ className, ...props }: React.ComponentProps<'p'>) {
  ...
  return (
    <p data-slot="form-message" id={formMessageId} className={cn('text-destructive-primary text-sm', className)} {...props}>
      {body}
    </p>
  );
}
