  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        today: cn(
          'bg-muted ring ring-muted-active text-foreground data-[selected=true]:rounded-none',
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        'data-[selected-single=true]:bg-brand-magenta-primary data-[selected-single=true]:text-brand-magenta-primary-foreground data-[range-middle=true]:bg-brand-flamingo data-[range-middle=true]:text-foreground data-[range-start=true]:bg-brand-flamingo-primary data-[range-start=true]:text-brand-flamingo-primary-foreground data-[range-end=true]:bg-brand-flamingo-primary data-[range-end=true]:text-brand-flamingo-primary-foreground group-data-[focused=true]/day:border-ring group-data-[focused=true]/day:ring-ring/50 dark:hover:text-accent-foreground flex aspect-square size-auto w-full min-w-(--cell-size) flex-col gap-1 leading-none font-normal group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10 group-data-[focused=true]/day:ring-[3px] data-[range-end=true]:rounded-md data-[range-end=true]:rounded-r-md data-[range-middle=true]:rounded-none data-[range-start=true]:rounded-md data-[range-start=true]:rounded-l-md [&>span]:text-xs [&>span]:opacity-70 rounded-none',
        defaultClassNames.day,
        className
      )}
      {...props}
